...
In this guide, we will guide you to develop a barcode scanning app with the [`BarcodeScanner`](https://dynamsoft.github.io/barcode-reader-react-native-samples/APIReferences/dynamsoft-barcode-reader-bundle-react-native) component.
...
However, if you want to achieve a higher level of customization, we recommend that you use our Foundation APIs and see this [Foundation Barcode Reader Guide](./guide-scan-barcodes-foundational-api.md).
...
Run the following commands in the root directory of your react-native project to add `dynamsoft-capture-vision-react-native` and `dynamsoft-barcode-reader-bundle-react-native` into dependencies
...
### Simplest Example
```typescript jsx
import { BarcodeScanner, BarcodeScanConfig, BarcodeScanResult } from 'dynamsoft-barcode-reader-bundle-react-native';
...
### Barcode Scan Result
Also see it in the [BarcodeScanResult](https://dynamsoft.github.io/barcode-reader-react-native-samples/APIReferences/dynamsoft-barcode-reader-bundle-react-native/interfaces/BarcodeScanResult.html) section of API References.
...
Also see it in the [BarcodeScanConfig](https://dynamsoft.github.io/barcode-reader-react-native-samples/APIReferences/dynamsoft-barcode-reader-bundle-react-native/interfaces/BarcodeScanConfig.html) section of API References.
```typescript jsx
import {BarcodeScanConfig} from 'dynamsoft-barcode-reader-bundle-react-native';
import {EnumBarcodeFormat} from 'dynamsoft-capture-vision-react-native';
